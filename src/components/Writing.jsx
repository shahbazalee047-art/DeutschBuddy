  ...
  return (
    <div className="fade-in">
      ...
      <div className="paper-card p-5">
        <div className=" p-4 mb-4 border border-gold/20" style={{ background: 'rgba(196,146,74,0.05)' }}><p className="text-[11px] font-bold text-gold mb-1 uppercase flex items-center gap-1" style={{ letterSpacing: '0.5px' }}><IconEdit className="w-3.5 h-3.5" /> Task:</p><p className="text-[14px] text-text-body">{content.prompt}</p></div>
