...
export default function Roleplay({ content, onComplete }) {
  ...
  return (
    <div className="fade-in">
      <h3 className="font-bold text-zinc-100 text-lg mb-5">🎭 Roleplay</h3>
      <div className="glass-card p-5">
        <div className="rounded-2xl p-4 mb-4 border border-warning/20" style={{ background: 'rgba(245, 158, 11, 0.05)' }}><p className="text-[11px] font-bold text-warning mb-1 uppercase" style={{ letterSpacing: '0.5px' }}>🎬 Scenario:</p><p className="text-[14px] text-zinc-300">{content.scenario}</p></div>
