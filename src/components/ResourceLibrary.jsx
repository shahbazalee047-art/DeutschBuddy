  ...
  return (
    <div className="fade-in space-y-5">
      <div>
        ...
        <h1 className="text-3xl font-bold text-text-dark editorial-heading" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", letterSpacing: '-0.5px' }}>Resource <i>Library</i></h1>
        <p className="text-text-muted" style={{ fontSize: '16px', lineHeight: '1.5' }}>Curated external resources to accelerate your German learning journey</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.map((r, i) => (
          <a key={i} href={r.url} target="_blank" rel="noopener noreferrer"
            ...
            <h3 className="text-[14px] font-bold text-text-body mb-1">{r.name}</h3>
            <p className="text-[12px] text-text-muted leading-relaxed line-clamp-2">{r.description}</p>
