...
export default function TaskRenderer({ task, onComplete }) {
  ...
  switch (task.type) {
    ...
    default: return <div className="text-center py-12"><p className="text-zinc-400 mb-4">Content coming soon!</p><button onClick={onComplete} className="btn-primary px-6">Mark Complete</button></div>;
  }
}
