  ...
  return (
    <div className="fade-in">
      ...
      <div className="paper-card p-6 mb-4 text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-3"><input type="text" value={input} onChange={e => setInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && !show && submit()} disabled={show} placeholder="Type the word..." className="w-56 paper-input text-center text-lg font-medium" /><SpeakerButton text={answer} size="md" /></div>
