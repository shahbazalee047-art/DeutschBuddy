      ...
      <div className="glass-card p-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="rounded-2xl p-4 text-center border border-sage-400/10" style={{ background: 'rgba(127, 176, 105, 0.05)' }}>
            <div className="text-2xl font-bold tabular-nums text-sage-400">{progress.xp}</div>
          ...
          <div className="rounded-2xl p-4 text-center border border-amber-400/10" style={{ background: 'rgba(212, 165, 116, 0.05)' }}>
            <div className="text-2xl font-bold tabular-nums text-amber-400">{streak}</div>
        ...
        <div>
          ...
          <div className="w-full h-2 rounded-full overflow-hidden" style={{ background: '#1B3429' }}>
            <div className="h-full rounded-full transition-all duration-500" style={{ width: `${Math.min((progress.xp / nextMilestone.target) * 100, 100)}%`, background: 'linear-gradient(90deg, #7FB069, #D4A574)' }} />
          </div>
        </div>
      </div>
    </div>
