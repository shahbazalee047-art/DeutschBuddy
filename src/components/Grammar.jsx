  ...
  return (
    <div className="fade-in reading-body">
      ...
      <div className="paper-card p-5">
        {content.rule && <div className=" p-4 mb-4 border border-gold/20" style={{ background: 'rgba(232,163,61,0.05)' }}><p className="text-[11px] font-bold text-gold mb-1 uppercase flex items-center gap-1" style={{ letterSpacing: '0.5px' }}><IconEdit className="w-3.5 h-3.5" /> Rule:</p><p className="text-[14px] font-medium text-text-body">{content.rule}</p></div>}
        ...
        {content.note && <div className=" p-3 mt-3 border border-gold/20" style={{ background: 'rgba(232,163,61,0.05)' }}><p className="text-[12px] text-text-body flex items-center gap-1"><IconLightbulb className="w-3.5 h-3.5 text-gold" /> {content.note}</p></div>}
      </div>
