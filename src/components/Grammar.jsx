  ...
  return (
    <div className="fade-in">
      ...
      <div className="bg-slate-800 border border-slate-700/50 rounded-2xl p-5">
        {content.rule && <div className="bg-purple-400/10 border border-purple-400/20 rounded-xl p-4 mb-4"><p className="text-xs text-purple-400 font-medium mb-1">📏 Rule:</p><p className="text-sm text-purple-300 font-medium">{content.rule}</p></div>}
      ...
      <div className="text-center mt-4"><button onClick={onComplete} className="px-5 py-2.5 bg-lime-400 text-slate-900 rounded-xl text-sm font-semibold hover:bg-lime-300 transition hover:scale-[1.02]">✓ I understand this grammar</button></div>
    </div>
  );
}
