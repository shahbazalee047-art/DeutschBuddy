...
export default function QuickWin({ onComplete }) {
  ...
  return (
    <div className="bg-slate-800 border border-slate-700/50 rounded-2xl p-4 slide-up">
      <div className="flex items-center gap-2 mb-3"><span className="text-lg">⚡</span><h4 className="text-sm font-bold text-slate-200">Quick Win</h4><span className="text-[10px] px-2 py-0.5 rounded-full font-medium text-black" style={{ background: '#FFCC00' }}>Under 3 min</span></div>
