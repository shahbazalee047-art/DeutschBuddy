...
export default function SignupPage() {
  ...
  if (success) return (<div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: 'radial-gradient(ellipse at top, #1e293b 0%, #0f172a 50%, #020617 100%)' }}><div className="max-w-md w-full text-center p-8 bg-slate-800 border border-slate-700/50 rounded-2xl"><div className="text-6xl mb-6">📬</div><h1 className="text-2xl font-bold text-white mb-3" style={{ fontFamily: 'Poppins, sans-serif' }}>Check your email</h1><p className="text-slate-400 mb-6 text-sm">We sent a confirmation link to <strong className="text-slate-200">{email}</strong>. Please verify to continue.</p><Link to="/login" className="inline-block px-6 py-3 text-black font-semibold rounded-xl transition-all duration-200 hover:scale-[1.02] text-sm" style={{ background: '#FFCC00' }}>Go to Sign In</Link></div><div className="mt-8"><Footer /></div></div>);
    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'radial-gradient(ellipse at top, #1e293b 0%, #0f172a 50%, #020617 100%)' }}>
      <div className="flex-1 flex">
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
          ...
          <div className="absolute top-20 right-20 text-[100px] font-black select-none" aria-hidden="true" style={{ color: 'rgba(30,41,59,0.5)' }}>🇩🇪</div>
          <div className="relative z-10 px-16 max-w-lg">
            <div className="flex items-center gap-3 mb-8"><div className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl" aria-hidden="true" style={{ background: 'rgba(255,204,0,0.1)', border: '1px solid rgba(255,204,0,0.2)' }}>🇩🇪</div><div><span className="text-3xl font-extrabold text-white tracking-tight" style={{ fontFamily: 'Poppins, sans-serif' }}>Deutsch</span><span className="text-3xl font-extrabold tracking-tight" style={{ fontFamily: 'Poppins, sans-serif', color: '#FFCC00' }}>Buddy</span></div></div>
            ...
            <div className="grid grid-cols-2 gap-3"><div className="bg-slate-800/80 border border-slate-700/50 rounded-2xl px-4 py-4 text-center"><div className="text-xl font-bold text-white">Gamified</div><div className="text-xs text-slate-400 mt-0.5">XP, streaks, badges</div></div><div className="bg-slate-800/80 border border-slate-700/50 rounded-2xl px-4 py-4 text-center"><div className="text-xl font-bold text-white">Flexible</div><div className="text-xs text-slate-400 mt-0.5">Your pace</div></div></div>
          </div>
        </div>
