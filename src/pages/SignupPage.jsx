    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: 'linear-gradient(to top right, #131A2E, #111827, #1A1A32)' }}>
        <div className="max-w-md w-full text-center glass-card p-8">
          ...
          <h2 className="text-2xl font-bold text-slate-100 mb-3" style={{ fontFamily: 'Poppins, sans-serif' }}>Check your email</h2>
          <p className="text-slate-500 mb-6 text-sm">We sent a confirmation link to <strong className="text-slate-300">{email}</strong>. Please verify to continue.</p>
    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(to top right, #131A2E, #111827, #1A1A32)' }}>
      <div className="flex-1 flex">
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
          ...
          <div className="absolute top-20 right-20 text-[100px] font-black text-white/[0.03]">🇩🇪</div>
          <div className="relative z-10 px-16 max-w-lg">
            ...
            <h1 className="text-4xl font-bold text-slate-100 mb-4 leading-tight" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Start your journey.<br /><span className="text-slate-500">It's free.</span>
            </h1>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white/[0.03] border border-slate-700/40 rounded-2xl px-4 py-4 text-center backdrop-blur-sm">
                <div className="text-xl font-bold text-slate-200">Gamified</div>
                <div className="text-xs text-slate-500 mt-0.5">XP, streaks, badges</div>
              </div>
              <div className="bg-white/[0.03] border border-slate-700/40 rounded-2xl px-4 py-4 text-center backdrop-blur-sm">
                <div className="text-xl font-bold text-slate-200">Flexible</div>
                <div className="text-xs text-slate-500 mt-0.5">Your pace</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white/[0.01] backdrop-blur-lg border-l border-white/[0.05]">
          <div className="w-full max-w-md">
            ...
            <h2 className="text-2xl font-bold text-slate-100 mb-1" style={{ fontFamily: 'Poppins, sans-serif' }}>Create your account</h2>
            <p className="text-slate-500 mb-8 text-sm">Start learning German today</p>
