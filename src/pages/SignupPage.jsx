    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-zinc-950">
        <div className="max-w-md w-full text-center p-8 bg-zinc-900 border border-zinc-800 rounded-2xl">
          ...
          <p className="text-zinc-400 mb-6 text-sm">We sent a confirmation link to <strong className="text-zinc-200">{email}</strong>. Please verify to continue.</p>
          <Link to="/login" className="inline-block px-6 py-3 bg-lime-400 hover:bg-lime-300 text-zinc-950 font-semibold rounded-xl transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-lime-400/20 text-sm">Go to Sign In</Link>
        </div>
    ...
    <div className="min-h-screen flex flex-col bg-zinc-950">
      <div className="flex-1 flex">
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
          ...
          <div className="absolute top-20 right-20 text-[100px] font-black text-zinc-800/50 select-none" aria-hidden="true">🇩🇪</div>
          ...
          <div className="relative z-10 px-16 max-w-lg">
            ...
            <h1 className="text-4xl font-bold text-white mb-4 leading-tight" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Start your journey.<br /><span className="text-zinc-500">It's free.</span>
            </h1>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl px-4 py-4 text-center">
                <div className="text-xl font-bold text-white">Gamified</div>
                <div className="text-xs text-zinc-500 mt-0.5">XP, streaks, badges</div>
              </div>
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl px-4 py-4 text-center">
                <div className="text-xl font-bold text-white">Flexible</div>
                <div className="text-xs text-zinc-500 mt-0.5">Your pace</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-md">
            ...
            <p className="text-zinc-400 mb-8 text-sm">Start learning German today</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="signup-name" className="block text-sm font-medium text-zinc-400 mb-1.5">Full Name</label>
              ...
              <div>
                <label htmlFor="signup-email" className="block text-sm font-medium text-zinc-400 mb-1.5">Email</label>
                <input id="signup-email" type="email" value={email} onChange={e => setEmail(e.target.value)} required
                  className="w-full px-4 py-3 bg-zinc-900 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-lime-400 focus:border-transparent transition-all duration-200 text-sm"
                  placeholder="name@example.com" />
              </div>
              <div>
                <label htmlFor="signup-password" className="block text-sm font-medium text-zinc-400 mb-1.5">Password</label>
                <input id="signup-password" type="password" value={password} onChange={e => setPassword(e.target.value)} required
                  className="w-full px-4 py-3 bg-zinc-900 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-lime-400 focus:border-transparent transition-all duration-200 text-sm"
                  placeholder="••••••••" />
              </div>
              <div>
                <label htmlFor="signup-confirm" className="block text-sm font-medium text-zinc-400 mb-1.5">Confirm Password</label>
