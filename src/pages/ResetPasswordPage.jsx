    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: 'linear-gradient(to top right, #131A2E, #111827, #1A1A32)' }}>
        <div className="max-w-md w-full text-center glass-card p-8">
          ...
          <h2 className="text-2xl font-bold text-slate-100 mb-3" style={{ fontFamily: 'Poppins, sans-serif' }}>Password updated</h2>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: 'linear-gradient(to top right, #131A2E, #111827, #1A1A32)' }}>
      <div className="max-w-md w-full">
        <div className="glass-card p-8">
          <h2 className="text-2xl font-bold text-slate-100 mb-2" style={{ fontFamily: 'Poppins, sans-serif' }}>Set new password</h2>
          <p className="text-slate-500 mb-6 text-sm">Choose a strong new password.</p>
