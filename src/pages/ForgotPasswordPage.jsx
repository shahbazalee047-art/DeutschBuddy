    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: '#0D1A14' }}>
        <div className="max-w-md text-center">
          <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 border border-sage-400/20" style={{ background: 'rgba(127, 176, 105, 0.1)' }}><IconMail className="w-8 h-8 text-sage-400" /></div>
          <h1 className="text-3xl font-bold text-cream-100 mb-3" style={{ fontFamily: 'DM Serif Display, serif' }}>Check your email</h1>
          <p className="text-cream-400 mb-6" style={{ fontSize: '16px', lineHeight: '1.6' }}>We've sent a password reset link to <strong className="text-cream-200">{email}</strong></p>
          <Link to="/login" className="text-sage-400 hover:text-sage-300 font-semibold transition">Back to login</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#0D1A14' }}>
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-3xl font-bold text-cream-100 mb-2 text-center" style={{ fontFamily: 'DM Serif Display, serif', letterSpacing: '-0.5px' }}>Reset password</h1>
          <p className="text-cream-500 text-center mb-8" style={{ fontSize: '16px' }}>Enter your email and we'll send you a reset link</p>
