    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(to top right, #131A2E, #111827, #1A1A32)' }}>
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
          ...
          <div className="absolute top-16 left-16 text-[100px] font-black text-white/[0.03] select-none" aria-hidden="true">A1</div>
          <div className="absolute bottom-16 right-16 text-[100px] font-black text-white/[0.03] select-none" aria-hidden="true">A2</div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white/[0.01] backdrop-blur-lg border-l border-white/[0.05]">
          <div className="w-full max-w-md">
            ...
            <h1 className="text-2xl font-bold text-slate-100 mb-1" style={{ fontFamily: 'Poppins, sans-serif' }}>Welcome!</h1>
            <p className="text-slate-300 mb-8 text-sm">Sign in to continue your German journey</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input id="login-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required
                  className="w-full px-4 py-3 bg-slate-950/40 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition text-sm"
              ...
              <div>
                ...
                <div className="relative">
                  <input id="login-password" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required
                    className="w-full px-4 py-3 pr-12 bg-slate-950/40 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition text-sm"
              ...
              <button type="submit" disabled={loading}
                className="w-full py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2">
