    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(to top right, #131A2E, #111827, #1A1A32)' }}>
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
          ...
          <div className="absolute top-16 left-16 text-[100px] font-black text-white/[0.03]" aria-hidden="true">A1</div>
          <div className="absolute bottom-16 right-16 text-[100px] font-black text-white/[0.03]" aria-hidden="true">A2</div>
